...
const stats = [
  { label: "FOUNDED", value: "2024", accent: false },
  { label: "STORES SERVED", value: "500+", accent: false },
  { label: "TOTAL CALLS", value: "1,84k+", accent: false },
  { label: "UPTIME SLA", value: "99.9%", accent: true },
];
...
function AnimatedStat({ label, value, accent, delay }: { label: string; value: string; accent: boolean; delay: number }) {
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .founder-overlay {
          ...
          background: linear-gradient(0deg, rgba(14,13,18,0.97) 0%, rgba(14,13,18,0.6) 60%, transparent 100%);
      ...
      <div className="meet-root">
        <div className="inner">
          ...
          <div
            ref={heroRef.ref}
            className={`section-header fade-up${heroRef.inView ? " visible" : ""}`}
          >
          ...
          <div className="main-grid">
            ...
            <div
              ref={leftRef.ref}
              className={`fade-up${leftRef.inView ? " visible" : ""}`}
            >
            ...
            <div className="right-col">
              ...
              <div
                ref={founderRef.ref}
                className={`founder-card fade-up${founderRef.inView ? " visible" : ""}`}
              >
                <div className="scan" />
                <img
                  src="/d.svg"
              ...
              <div className="cards-row">
                <div
                  ref={card1Ref.ref}
                  className={`team-card fade-up d1${card1Ref.inView ? " visible" : ""}`}
                >
                  ...
                  <div className="card-desc">
                    4 engineers across Hyderabad and Bangalore focused on platform stability and performance.
                  </div>
                ...
                <div
                  ref={card2Ref.ref}
                  className={`team-card fade-up d2${card2Ref.inView ? " visible" : ""}`}
                >
                  <div className="avatars">
                    {["SN","PR"].map((init, i) => (
                      <div className="avatar" key={i}>{init}</div>
                  ...
                  <div className="card-desc">
                    2 former WooCommerce store managers who understand the merchant journey from the inside out.
                  </div>
                  <div className="card-tag">
                    <span className="card-tag-dot" />
                    Merchant First
          ...
          <div className="stats-bar">
            {stats.map((s, i) => (
              <AnimatedStat key={i} {...s} delay={i * 120} />
            ))}
          </div>
